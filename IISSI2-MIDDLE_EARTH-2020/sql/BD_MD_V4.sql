...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEC_FOTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 22 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEC_PEDIDO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 163 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEC_PROVEEDOR"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 181 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEC_RESERVA
--------------------------------------------------------

   CREATE SEQUENCE  "SEC_RESERVA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 143 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEC_TICKET
--------------------------------------------------------

   CREATE SEQUENCE  "SEC_TICKET"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 22 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEC_USUARIO
--------------------------------------------------------

   CREATE SEQUENCE  "SEC_USUARIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 263 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "ADMINISTRADOR" ("EMAIL" CHAR(90), "CONTRASENA" CHAR(120)) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "PEDIDOS" ("OID_PEDIDO" NUMBER, "FECHA" DATE, "ID" NUMBER(9,0), "OID_U" NUMBER) ;
--------------------------------------------------------
...
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('101','45645645H','Manuel','Rivas','M','12345','321558968');
...
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('103','66512343F','Francisco','Cabello Linares','P','9879','456123456');
REM INSERTING into FOTO
SET DEFINE OFF;
Insert into FOTO (OID_FOTO,URL,OID_PR) values ('2','images/s0.jpg','123457');
...
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('126','P23423434','Prueba 5','666666969','123');
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('145','U87654321','Probando Insert','656565656','Calle de prueba 2');
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('161','A98798787','Firulais Juegos','654654654','Matias,13');
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('163','B12321323','Comiccc','654987987','Calle 14');
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('164','B12612323','Antonio','123123123','Calle 13');
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('165','Q23423423','ToySA','968585744','Hola n?34');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PK_PEDIDOS2" ON "PEDIDOS" ("OID_PEDIDO") ;
--------------------------------------------------------
...
BEGIN
    ...
    raise_application_error (-20600, 'No puede haber dos usuarios con el mismo correo electr?nico');
    END IF;
END;
...
/
--------------------------------------------------------
--  DDL for Procedure ACTUALIZAR_PEDIDOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ACTUALIZAR_PEDIDOS" 
(W_OID_PEDIDO IN PEDIDOS.OID_PEDIDO%TYPE,
W_FECHA IN PEDIDOS.FECHA%TYPE,
W_ID IN PEDIDOS.ID%TYPE,
W_OID_U IN PEDIDOS.OID_U%TYPE) AS
BEGIN
    UPDATE PEDIDOS SET FECHA = W_FECHA WHERE OID_PEDIDO = W_OID_PEDIDO;
    UPDATE PEDIDOS SET ID = W_ID WHERE OID_PEDIDO = W_OID_PEDIDO;
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "ELIMINAR_PEDIDOS" 
(W_OID_PEDIDO IN PEDIDOS.OID_PEDIDO%TYPE) AS
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "NUEVO_PEDIDO" (W_FECHA IN PEDIDOS.FECHA%TYPE,W_ID IN PEDIDOS.ID%TYPE)  IS
  BEGIN
   INSERT INTO PEDIDOS (FECHA,ID)
  VALUES ( W_FECHA,W_ID);
  END NUEVO_PEDIDO;
...
W_PRODUCTO IN RESERVA.PRODUCTO%TYPE,
W_EMAIL IN RESERVA.EMAIL%TYPE,
W_NOMBRE IN RESERVA.NOMBRE%TYPE);
...
W_OID_U IN PEDIDOS.OID_U%TYPE,
W_ID IN PEDIDOS.ID%TYPE,
W_FECHA IN PEDIDOS.FECHA%TYPE) AS
  BEGIN
   UPDATE PEDIDOS SET ID = W_ID WHERE OID_PEDIDO = W_OID_PEDIDO;
  UPDATE PEDIDOS SET FECHA = W_FECHA WHERE OID_PEDIDO = W_OID_PEDIDO;
  UPDATE PEDIDOS SET OID_U = w_OID_U WHERE OID_PEDIDO = W_OID_PEDIDO;
...
--------------------------------------------------------
  ...
  ALTER TABLE "TICKET" ADD CONSTRAINT "FK_E" FOREIGN KEY ("OID_E") REFERENCES "EMPLEADO" ("OID_E") ENABLE;
  ALTER TABLE "TICKET" ADD CONSTRAINT "FK_U" FOREIGN KEY ("OID_U") REFERENCES "USUARIO" ("OID_U") ENABLE;
--------------------------------------------------------
