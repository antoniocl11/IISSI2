...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEC_FOTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 62 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into PEDIDOS (OID_PEDIDO,FECHA,ID,OID_U) values ('163',to_date('01/01/01','DD/MM/RR'),'123456780','86');
Insert into PEDIDOS (OID_PEDIDO,FECHA,ID,OID_U) values ('164',to_date('21/05/20','DD/MM/RR'),'123456789','87');
Insert into PEDIDOS (OID_PEDIDO,FECHA,ID,OID_U) values ('144',to_date('01/05/21','DD/MM/RR'),'123456789','89');
...
Insert into PEDIDOS (OID_PEDIDO,FECHA,ID,OID_U) values ('183',to_date('01/01/01','DD/MM/RR'),'123456780','85');
Insert into PEDIDOS (OID_PEDIDO,FECHA,ID,OID_U) values ('184',to_date('21/05/20','DD/MM/RR'),'123456789','86');
...
BEGIN
  ...
  UPDATE TICKET SET OID_U = W_OID_U WHERE OID_TICKET = W_OID_TICKET;
  UPDATE TICKET SET OID_E = W_OID_E WHERE OID_TICKET = W_OID_TICKET;
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "NUEVO_PEDIDO" (W_FECHA IN PEDIDOS.FECHA%TYPE,W_ID IN PEDIDOS.ID%TYPE, W_OID_U IN PEDIDOS.OID_U%TYPE)  IS
  BEGIN
...
Insert into IISSI.RESERVA (OID_RES,FECHA,PRODUCTO,EMAIL,NOMBRE) values ('1',to_date('31/05/20','DD/MM/RR'),'Marvel Hulk','eduardodo@gmail.com','Eduardo');
Insert into IISSI.RESERVA (OID_RES,FECHA,PRODUCTO,EMAIL,NOMBRE) values ('2',to_date('31/05/20','DD/MM/RR'),'SpiderMan','eduardodo@gmail.com','Eduardo');
