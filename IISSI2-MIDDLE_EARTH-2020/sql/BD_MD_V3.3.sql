...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEC_EMPLEADO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEC_PROVEEDOR"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('21','15984785F','Manuel','Martín Cáceres','M','1000','951212435');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('22','15633636G','Pepe','Cornejo Trujillo','T','799','951951951');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('23','25558745H','Francisco','Pérez Gutiérrez','M','1000','859849544');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('24','63365524G','José','Linares Martín','T','799','636362533');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('25','34285684F','Antonio','Cáceres Martín','M','1000','456585699');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('26','17485698A','Ramón','Ralston Borrego','T','799','236523652');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('27','36963696F','Javier','Trigos Solís','M','1000','985895899');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('28','58586969F','Félix','Trigos Martín','T','799','969696936');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('29','12365874Y','Eduardo','Cáceres Linares','M','1000','585859565');
Insert into EMPLEADO (OID_E,NIF,NOMBRE,APELLIDOS,TURNO,SUELDO,ID) values ('30','78965896E','Manuel','Cabello Guerrero','T','799','456363636');
...
SET DEFINE OFF;
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('49','B65465447','Antonio','654654654','Claudio Guerin, 11');
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('64','B65465443','JuegosJuanito','654654654','Andorra nº21');
...
Insert into PROVEEDOR (OID_PV,CIF,NOMBRE,TELEFONO,DIRECCION) values ('44','B65465445','Game','603402185','Machado, 21');
...
Insert into USUARIO (OID_U,NIF,NOMBRE,APELLIDOS,EMAIL,TELEFONO,ESSOCIO,DIRECCION,FECHANACIMIENTO,CONTRASENA) values ('1','11111111X','Eduardo','Eduardo Eduardo','eduardodo@gmail.com','645323241','0','Calle Juan 2','12/12/12','test');

SELECT OID_U,contrasena FROM usuario WHERE email = 'eduardodo@gmail.com'