...
--------------------------------------------------------
  ...
  CREATE TABLE "USUARIO" ("OID_U" NUMBER, "NIF" CHAR(9), "NOMBRE" VARCHAR2(25), "APELLIDOS" VARCHAR2(50), "EMAIL" VARCHAR2(50), "TELEFONO" NUMBER(9,0), "ESSOCIO" NUMBER, "DIRECCION" VARCHAR2(75), "FECHANACIMIENTO" DATE, "CONTRASEÑA" VARCHAR2(100)) ;
--------------------------------------------------------
--  DDL for Table VENTA
--------------------------------------------------------
