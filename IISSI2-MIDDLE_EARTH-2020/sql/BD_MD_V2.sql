--------------------------------------------------------
-- Archivo creado  - lunes-abril-20-2020   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "PROVEEDOR" ("CIF" CHAR(9), "NOMBRE" VARCHAR2(20), "TELEFONO" NUMBER(9,0), "DIRECCION" VARCHAR2(75), "OID_PV" NUMBER) ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TR_USUARIOS_EDAD
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "TR_USUARIOS_EDAD" 
BEFORE INSERT OR UPDATE ON Usuario
FOR EACH ROW
DECLARE 
  anhos NUMBER;
BEGIN
  anhos := (SYSDATE - :NEW.fechaNacimiento) / 365.25;
    IF(anhos < 16) 
      THEN raise_application_error
      (-10,'Un usuario debe ser mayor de 16 años');
    END IF;
END;
/
ALTER TRIGGER "TR_USUARIOS_EDAD" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "PROVEEDOR" MODIFY ("OID_PV" NOT NULL ENABLE);
